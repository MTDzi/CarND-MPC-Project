...
// Started with the values from MPC-Quizzes (25 and 0.05), but the car was
// too variable. I then limited `dt` but that wasn't it. I've experimented
// a lot with `N` and `dt` but finally settled with the following
size_t N = 10;
double dt = 0.1;
